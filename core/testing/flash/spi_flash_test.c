...
static void spi_flash_test_discover_device_properties_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_discover_device_properties_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status = flash_master_mock_expect_rx_xfer (&mock, 0, (uint8_t*) params, 0x40,
		FLASH_EXP_READ_CMD (0x5a, 0x000040, 1, -1, 0x40));
	status |= mock_expect (&mock.mock, mock.base.capabilities, &mock,
		FLASH_CAP_3BYTE_ADDR | FLASH_CAP_4BYTE_ADDR);
	...
	status = spi_flash_get_device_size (&flash, &out);
	CuAssertIntEquals (test, 0, status);
	CuAssertIntEquals (test, (256 * 1024 * 1024), out);
...
static void spi_flash_test_discover_device_properties_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status = spi_flash_get_device_size (&flash, &out);
	CuAssertIntEquals (test, 0, status);
	CuAssertIntEquals (test, (8 * 1024 * 1024), out);
...
static void spi_flash_test_enable_4byte_address_mode_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_enable_4byte_address_mode_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	spi_flash_testing_discover_params (test, &flash, &state, &mock, TEST_ID, header, params,
		sizeof (params), 0x000010, FULL_CAPABILITIES);
...
static void spi_flash_test_enable_4byte_address_mode_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	spi_flash_testing_discover_params (test, &flash, &state, &mock, TEST_ID, header, params,
		0x40, 0x000040, FULL_CAPABILITIES);
...
static void spi_flash_test_force_4byte_address_mode_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_force_4byte_address_mode_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_force_4byte_address_mode_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_detect_4byte_address_mode_micron_x (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	int status;
	uint8_t micron_x[] = {0x2c, 0x5b, 0x1c};
	const size_t length = sizeof (micron_x);
	uint8_t enable_expected[] = {0x01};
	uint8_t disable_expected[] = {~0x01};
	...
	status = flash_master_mock_expect_rx_xfer (&mock, 0, micron_x, length,
		FLASH_EXP_READ_REG (0x9f, length));
...
static void spi_flash_test_detect_4byte_address_mode_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_detect_4byte_address_mode_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_detect_4byte_address_mode_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_detect_4byte_address_mode_error_read_reg_micron_x (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_force_reset_device (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status = spi_flash_force_reset_device (&flash, 1);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_force_reset_device_command_66_99 (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status = spi_flash_force_reset_device (&flash, 0);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_force_reset_device_command_f0 (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status = spi_flash_force_reset_device (&flash, 5);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_force_reset_device_not_supported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_force_reset_device_no_revert_address_mode (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_force_reset_device_static (CuTest *test)
{
	struct flash_master_mock mock;
	struct spi_flash_state state;
	struct spi_flash flash = spi_flash_static_init (SPI_FLASH_API_INIT, &state, &mock.base);
...
static void spi_flash_test_force_reset_device_null (CuTest *test)
{
	int status;

	TEST_START;

	status = spi_flash_force_reset_device (NULL, 1);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);
}

static void spi_flash_test_force_reset_device_error_enable (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_force_reset_device_error_resetting (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_clear_block_protect_infineon_already_clear (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	int status;
	uint8_t wip_status = FLASH_FLAG_STATUS_READY;
	uint8_t clear_expected[] = {~0x1c};
	uint8_t single_byte[] = {0xC0};
	...
	status = flash_master_mock_expect_rx_xfer (&mock, 0, FLASH_ID_S28HS02GT, 3,
		FLASH_EXP_READ_REG (0x9f, 3));

	status |= flash_master_mock_expect_rx_xfer (&mock, 0, clear_expected, sizeof (clear_expected),
		FLASH_EXP_READ_REG (0x05, sizeof (clear_expected)));

	status |= flash_master_mock_expect_rx_xfer (&mock, 0, &wip_status, 1,
		FLASH_EXP_READ_STATUS_REG);
	status |= flash_master_mock_expect_xfer (&mock, 0, FLASH_EXP_WRITE_ENABLE);
	status |= flash_master_mock_expect_tx_xfer (&mock, 0,
		FLASH_EXP_WRITE_4B_CMD (0x71, 0x00800005, 0, single_byte, sizeof (single_byte)));
	status |= flash_master_mock_expect_rx_xfer (&mock, 0, &wip_status, 1,
		FLASH_EXP_READ_STATUS_REG);
...
static void spi_flash_test_clear_block_protect_infineon_protected (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	int status;
	uint8_t wip_status = FLASH_FLAG_STATUS_READY;
	uint8_t reg_set[] = {0x1c};
	uint8_t clear_expected[] = {0x0};
	uint8_t single_byte[] = {0xC0};
	...
	status |= flash_master_mock_expect_xfer (&mock, 0, FLASH_EXP_WRITE_ENABLE);
	status |= flash_master_mock_expect_tx_xfer (&mock, 0,
		FLASH_EXP_WRITE_4B_CMD (0x71, 0x00800000, 0, clear_expected, sizeof (clear_expected)));
	status |= flash_master_mock_expect_rx_xfer (&mock, 0, &wip_status, 1,
		FLASH_EXP_READ_STATUS_REG);
...
static void spi_flash_test_clear_block_protect_mx66uw_already_clear (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	int status;
	uint8_t wip_status = FLASH_FLAG_STATUS_READY;
	uint8_t clear_expected[] = {~0x3c};
	uint8_t single_byte[] = {0x02};
	...
	status = flash_master_mock_expect_rx_xfer (&mock, 0, FLASH_ID_MX66UW2G345G, 3,
		FLASH_EXP_READ_REG (0x9f, 3));
	...
	status |= flash_master_mock_expect_xfer (&mock, 0, FLASH_EXP_WRITE_ENABLE);
	status |= flash_master_mock_expect_tx_xfer (&mock, 0,
		FLASH_EXP_WRITE_4B_CMD (0x72, 0x00000400, 0, single_byte, sizeof (single_byte)));
	status |= flash_master_mock_expect_rx_xfer (&mock, 0, &wip_status, 1,
		FLASH_EXP_READ_STATUS_REG);
...
static void spi_flash_test_clear_block_protect_mx66uw_protected (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_clear_block_protect_error_infineon_read_str1 (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status |= flash_master_mock_expect_rx_xfer (&mock, FLASH_MASTER_XFER_FAILED, clear_expected,
		sizeof (clear_expected), FLASH_EXP_READ_REG (0x05, sizeof (clear_expected)));
...
static void spi_flash_test_clear_block_protect_error_infineon_write_str1 (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_clear_block_protect_error_infineon_write_cfgr4 (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status |= flash_master_mock_expect_xfer (&mock, 0, FLASH_EXP_WRITE_ENABLE);
	status |= flash_master_mock_expect_tx_xfer (&mock, FLASH_MASTER_XFER_FAILED,
		FLASH_EXP_WRITE_4B_CMD (0x71, 0x00800005, 0, single_byte,
			sizeof (single_byte)));
...
static void spi_flash_test_clear_block_protect_error_mx66uw_read_sr (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_clear_block_protect_error_mx66uw_write_sr (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_clear_block_protect_error_mx66uw_write_cfgr2 (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status |= flash_master_mock_expect_xfer (&mock, 0, FLASH_EXP_WRITE_ENABLE);
	status |= flash_master_mock_expect_tx_xfer (&mock, FLASH_MASTER_XFER_FAILED,
		FLASH_EXP_WRITE_4B_CMD (0x72, 0x00000400, 0, single_byte,
			sizeof (single_byte)));
...
static void spi_flash_test_initialize_device_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_initialize_device_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_initialize_device_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	uint8_t macronix[] = {0xc2, 0x94, 0x3c};
	uint8_t reg_set[] = {0x3c};
	uint8_t clear_expected[] = {0x0};
	uint8_t single_byte[] = {0x02};
	uint32_t out;
	...
	status |= flash_master_mock_expect_rx_xfer (&mock, 0, macronix, FLASH_ID_LEN,
		FLASH_EXP_READ_REG (0x9f, FLASH_ID_LEN));
	status |= flash_master_mock_expect_rx_xfer (&mock, 0, (uint8_t*) header, sizeof (header),
		FLASH_EXP_READ_CMD (0x5a, 0x000000, 1, -1, 0x10));
	status |= flash_master_mock_expect_rx_xfer (&mock, 0, (uint8_t*) params, 0x40,
		FLASH_EXP_READ_CMD (0x5a, 0x000040, 1, -1, 0x40));
	status |= mock_expect (&mock.mock, mock.base.capabilities, &mock,
		FLASH_CAP_3BYTE_ADDR | FLASH_CAP_4BYTE_ADDR);
...
static void spi_flash_test_initialize_device_fast_read (CuTest *test)
{
	...
	status = spi_flash_initialize_device (&flash, &state, &mock.base, true, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_wake_device (CuTest *test)
{
	...
	status = spi_flash_initialize_device (&flash, &state, &mock.base, false, true,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_reset_device (CuTest *test)
{
	...
	status = spi_flash_initialize_device (&flash, &state, &mock.base, false, false,
		SPI_FLASH_RESET_REQUIRED, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_reset_device_if_supported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	status = spi_flash_initialize_device (&flash, &state, &mock.base, false, false,
		SPI_FLASH_RESET_IF_SUPPORTED, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_reset_device_if_supported_not_supported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_initialize_device_wake_reset_if_supported_and_drive_strength (
	CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	...
	status = spi_flash_initialize_device (&flash, &state, &mock.base, false, true,
		SPI_FLASH_RESET_IF_SUPPORTED, true);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_init_error (CuTest *test)
{
	...
	status = spi_flash_initialize_device (NULL, &state, &mock.base, false, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);

	status = spi_flash_initialize_device (&flash, NULL, &mock.base, false, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);

	status = spi_flash_initialize_device (&flash, &state, NULL, false, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);
...
static void spi_flash_test_initialize_device_init_fast_read_error (CuTest *test)
{
	...
	status = spi_flash_initialize_device (NULL, &state, &mock.base, true, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);

	status = spi_flash_initialize_device (&flash, NULL, &mock.base, true, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);

	status = spi_flash_initialize_device (&flash, &state, NULL, true, false,
		SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);
...
static void spi_flash_test_initialize_device_reset_not_supported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_initialize_device_state_3byte_only (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (&flash, false, false, SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_fast_read (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (&flash, true, false, SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_wake_device (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (&flash, false, true, SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_reset_device (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (&flash, false, false, SPI_FLASH_RESET_REQUIRED,
		false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_reset_device_if_supported (CuTest *test)
{
	struct flash_master_mock mock;
	struct spi_flash_state state;
	struct spi_flash flash = spi_flash_static_init (SPI_FLASH_API_INIT, &state, &mock.base);
	...
	status = spi_flash_initialize_device_state (&flash, false, false, SPI_FLASH_RESET_IF_SUPPORTED,
		false);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_reset_device_if_supported_not_supported (
	CuTest *test)
{
	struct flash_master_mock mock;
	struct spi_flash_state state;
...
static void spi_flash_test_initialize_device_state_drive_strength (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (&flash, true, false, SPI_FLASH_RESET_NONE, true);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_wake_reset_and_drive_strength (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (&flash, false, true, SPI_FLASH_RESET_REQUIRED,
		true);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_wake_reset_if_supported_and_drive_strength (
	CuTest *test)
{
	struct flash_master_mock mock;
	struct spi_flash_state state;
	...
	status = spi_flash_initialize_device_state (&flash, false, true, SPI_FLASH_RESET_IF_SUPPORTED,
		true);
	CuAssertIntEquals (test, 0, status);
...
static void spi_flash_test_initialize_device_state_init_error (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (NULL, false, false, SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);
...
static void spi_flash_test_initialize_device_state_init_fast_read_error (CuTest *test)
{
	...
	status = spi_flash_initialize_device_state (NULL, true, false, SPI_FLASH_RESET_NONE, false);
	CuAssertIntEquals (test, SPI_FLASH_INVALID_ARGUMENT, status);
...
static void spi_flash_test_initialize_device_state_reset_not_supported (CuTest *test)
{
	struct flash_master_mock mock;
	struct spi_flash_state state;
	struct spi_flash flash = spi_flash_static_init (SPI_FLASH_API_INIT, &state, &mock.base);
...
static void spi_flash_test_is_address_mode_fixed_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_is_address_mode_fixed_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_is_address_mode_fixed_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_address_mode_requires_write_enable_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_address_mode_requires_write_enable_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_address_mode_requires_write_enable_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
	...
	uint32_t capabilities = FLASH_CAP_4BYTE_ADDR | FLASH_CAP_3BYTE_ADDR;
...
static void spi_flash_test_is_4byte_address_mode_on_reset_micron_x (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_is_4byte_address_mode_on_reset_4byte_mode_unsupported (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_is_4byte_address_mode_on_reset_4byte_mode_fixed (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_is_4byte_address_mode_on_reset_4byte_mode_instruction_set (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
static void spi_flash_test_is_4byte_address_mode_on_reset_error_read_reg_micron_x (CuTest *test)
{
	struct spi_flash_state state;
	struct spi_flash flash;
	struct flash_master_mock mock;
...
TEST (spi_flash_test_discover_device_properties_4byte_mode_fixed);
TEST (spi_flash_test_discover_device_properties_4byte_mode_instruction_set);
TEST (spi_flash_test_discover_device_properties_4byte_mode_unsupported);
...
TEST (spi_flash_test_enable_4byte_address_mode_4byte_mode_unsupported);
TEST (spi_flash_test_enable_4byte_address_mode_3byte_4byte);
TEST (spi_flash_test_enable_4byte_address_mode_4byte_only);
TEST (spi_flash_test_enable_4byte_address_mode_4byte_mode_fixed);
TEST (spi_flash_test_enable_4byte_address_mode_4byte_mode_instruction_set);
...
TEST (spi_flash_test_force_4byte_address_mode_4byte_mode_unsupported);
TEST (spi_flash_test_force_4byte_address_mode_3byte_4byte);
TEST (spi_flash_test_force_4byte_address_mode_4byte_only);
TEST (spi_flash_test_force_4byte_address_mode_4byte_mode_fixed);
TEST (spi_flash_test_force_4byte_address_mode_4byte_mode_instruction_set);
...
TEST (spi_flash_test_detect_4byte_address_mode_micron_x);
...
TEST (spi_flash_test_detect_4byte_address_mode_4byte_mode_unsupported);
TEST (spi_flash_test_detect_4byte_address_mode_3byte_4byte);
TEST (spi_flash_test_detect_4byte_address_mode_4byte_only);
TEST (spi_flash_test_detect_4byte_address_mode_4byte_mode_fixed);
TEST (spi_flash_test_detect_4byte_address_mode_4byte_mode_instruction_set);
...
TEST (spi_flash_test_detect_4byte_address_mode_error_read_reg_micron_x);
...
TEST (spi_flash_test_force_reset_device);
TEST (spi_flash_test_force_reset_device_command_66_99);
TEST (spi_flash_test_force_reset_device_command_f0);
TEST (spi_flash_test_force_reset_device_not_supported);
TEST (spi_flash_test_force_reset_device_no_revert_address_mode);
TEST (spi_flash_test_force_reset_device_static);
TEST (spi_flash_test_force_reset_device_null);
TEST (spi_flash_test_force_reset_device_error_enable);
TEST (spi_flash_test_force_reset_device_error_resetting);
...
TEST (spi_flash_test_clear_block_protect_infineon_already_clear);
TEST (spi_flash_test_clear_block_protect_infineon_protected);
TEST (spi_flash_test_clear_block_protect_mx66uw_already_clear);
TEST (spi_flash_test_clear_block_protect_mx66uw_protected);
...
TEST (spi_flash_test_clear_block_protect_error_infineon_read_str1);
TEST (spi_flash_test_clear_block_protect_error_infineon_write_str1);
TEST (spi_flash_test_clear_block_protect_error_infineon_write_cfgr4);
TEST (spi_flash_test_clear_block_protect_error_mx66uw_read_sr);
TEST (spi_flash_test_clear_block_protect_error_mx66uw_write_sr);
TEST (spi_flash_test_clear_block_protect_error_mx66uw_write_cfgr2);
...
TEST (spi_flash_test_initialize_device_4byte_mode_unsupported);
TEST (spi_flash_test_initialize_device_3byte_4byte);
TEST (spi_flash_test_initialize_device_4byte_only);
TEST (spi_flash_test_initialize_device_4byte_mode_fixed);
TEST (spi_flash_test_initialize_device_4byte_mode_instruction_set);
...
TEST (spi_flash_test_initialize_device_reset_device_if_supported);
TEST (spi_flash_test_initialize_device_reset_device_if_supported_not_supported);
TEST (spi_flash_test_initialize_device_drive_strength);
TEST (spi_flash_test_initialize_device_wake_reset_and_drive_strength);
TEST (spi_flash_test_initialize_device_wake_reset_if_supported_and_drive_strength);
...
TEST (spi_flash_test_initialize_device_reset_not_supported);
...
TEST (spi_flash_test_initialize_device_state_reset_device_if_supported);
TEST (spi_flash_test_initialize_device_state_reset_device_if_supported_not_supported);
...
TEST (spi_flash_test_initialize_device_state_wake_reset_if_supported_and_drive_strength);
...
TEST (spi_flash_test_initialize_device_state_reset_not_supported);
...
TEST (spi_flash_test_is_address_mode_fixed_4byte_mode_unsupported);
TEST (spi_flash_test_is_address_mode_fixed_3byte_4byte);
TEST (spi_flash_test_is_address_mode_fixed_4byte_only);
TEST (spi_flash_test_is_address_mode_fixed_4byte_mode_fixed);
TEST (spi_flash_test_is_address_mode_fixed_4byte_mode_instruction_set);
...
TEST (spi_flash_test_address_mode_requires_write_enable_4byte_mode_unsupported);
...
TEST (spi_flash_test_address_mode_requires_write_enable_4byte_mode_fixed);
TEST (spi_flash_test_address_mode_requires_write_enable_4byte_mode_instruction_set);
...
TEST (spi_flash_test_is_4byte_address_mode_on_reset_micron_x);
...
TEST (spi_flash_test_is_4byte_address_mode_on_reset_4byte_mode_unsupported);
TEST (spi_flash_test_is_4byte_address_mode_on_reset_4byte_only);
TEST (spi_flash_test_is_4byte_address_mode_on_reset_4byte_mode_fixed);
TEST (spi_flash_test_is_4byte_address_mode_on_reset_4byte_mode_instruction_set);
...
TEST (spi_flash_test_is_4byte_address_mode_on_reset_error_read_reg_micron_x);
